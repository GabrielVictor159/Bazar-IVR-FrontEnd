...
export default function Sobre(props) {
    ...
    useEffect(() => {
        ...
        const a = [
            ...
            {
                name: `${name}_container_2`,
                animationName: "topSurge"
            },
            {
                name: `${name}_NossoTime_titulo`,
                animationName: "topSurge"
            },
            {
                name: `${name}_NossoTime_texto`,
                animationName: "topSurge"
            },
            {
                name: `${name}_foter`,
        ...
        images.map((value,index)=>{
            a.push({
                name: `${name}_imagesInstituto_${index}`,
                animationName: "scale"
            })
        })
        membros.map((value,index)=>{
            a.push({
                name: `${name}_imagesMembros_${index}`,
                animationName: "scale"  
            })
        })
    ...
    return (
        <>
            {images !== false
                ? <>
                    <Head id={`${name}_nav`} atualizar={atualizar} setAtualizar={setAtualizar} active={"Sobre"} />
                    <div className={`${name}_body`}>
                        <br />
                        <div id={`${name}_banner1`} className={`${name}_container_1`}>
                            <img src={banner1} />
                            <div>
                                <a />
                                <h1>Sobre Nós</h1>
                        ...
                        <br /><br /><br />
                        <div id={`${name}_container_2`} className={`${name}_container_2`}>
                            <div>
                                <h6>SOBRE NÓS</h6>
                        ...
                        <br /><br /><br /><br />
                        <div id={`${name}_NossoTime_titulo`} style={{opacity:0}}>
                            <h1 style={{ fontSize: 35, borderBottom: '2px solid #FC81FF', paddingBottom: 20 }}>NOSSO TIME</h1>

                        </div>
                        <br />
                        <div id={`${name}_NossoTime_texto`} style={{opacity:0}}>
